 ...
 |_| \_\\__,_|_|\___|\__\__,_| \__,_|\___|_|
  ...
  |____/ \___||___/\__|_|_| |_|\___/ 
    ...
    def iniciar_partida(self) -> None:
        ...
        self._limpiar_pantalla() 
        print(f"Bienvenido al Averno, {nombre}. Tu destino comienza ahora.")
        ...
        while self.usuario.puntos_usuario >= 0 and self.usuario.puntos_usuario < 100:
            ...
            # Nota: No limpiamos dentro del loop para que puedas leer qué pasó en el turno anterior
    ...
    def menu_principal(self) -> None:
        while True:
            ...
            if opcion == "1":
                ...
                # Si se equivoca, no limpiamos inmediatamente para que lea el error
